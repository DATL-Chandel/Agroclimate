...
const CabbageContent = ({ isMobile, colors, styles }) => {
    return (
        <div style={{
            ...
            {/* Visual Flow Diagram for Cabbage */}
            <div style={{
                ...
                <div style={{
                    ...
                    {[
                        ...
                        { stage: 'Head Formation', gdd: '600-900', color: '#64B5F6' },
                        { stage: 'Maturation', gdd: '900-1100', color: '#42A5F5' }
            ...
            <div style={{
                ...
                <div>
                    ...
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        ...
                        <li style={styles.listItem}>Optimal soil temperatures for germination range between 45°F and 85°F.</li>
                    </ul>
                </div>
                ...
                <div>
                    <h5 style={{
                        ...
                        4. Head Formation (600-900 GDD)
                    </h5>
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Inner leaves begin to curl and form a compact head.</li>
                        <li style={styles.listItem}>Consistent moisture and nutrient availability are crucial during this stage.</li>
                    </ul>
                </div>
                ...
                <div>
                    <h5 style={{
                        ...
                        5. Maturation (900-1100 GDD)
                    </h5>
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Heads reach full size and firmness.</li>
                        <li style={styles.listItem}>Harvesting at the right time ensures optimal quality and yield.</li>
                        <li style={styles.listItem}>Delayed harvesting can lead to splitting.</li>
                    </ul>
                </div>
            </div>
                ...
                <div style={{
                    ...
                    <div>
                        <ul style={{...styles.list}}>
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://extension.umn.edu/planting-and-growing-guides/growing-cabbage" 
                                    target="_blank" 
                            ...
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://extension.umd.edu/resource/growing-cabbage-maryland" 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    style={{color: colors.link, textDecoration: 'none', fontWeight: '500'}}
                                >
                                ...
                                <span style={{fontSize: '13px', display: 'block', color: '#666', marginTop: '2px'}}>
                                    Growing Cabbage in Maryland
                                </span>
                            </li>
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://ipm.ucanr.edu/agriculture/cole-crops/growth-stages/" 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    style={{color: colors.link, textDecoration: 'none', fontWeight: '500'}}
                                >
                    ...
                    <div>
                        <ul style={{...styles.list}}>
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://extension.oregonstate.edu/crop-production/vegetables/cabbage-growing-guide" 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    style={{color: colors.link, textDecoration: 'none', fontWeight: '500'}}
                                >
                            ...
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://extension.psu.edu/commercial-vegetable-production-recommendations" 
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    style={{color: colors.link, textDecoration: 'none', fontWeight: '500'}}
                                >
