            ...
            <header style={styles.header}>
                ...
                <div style={styles.section}>
                    ...
                    <ul style={styles.list}>
                        ...
                        <li style={styles.listItem}><span style={styles.bold}>Climatic Data Trends:</span> Observe open-field weather factors, soil climate, and evapotranspiration trends over time.</li>
                        ...
                        <li style={styles.listItem}><span style={styles.bold}>Soil Parameter Analysis:</span> Analyze soil composition, pH, and other characteristics at different depths down to 2m.</li>
                        <li style={styles.listItem}><span style={styles.bold}>Growing Degree Days (GDD):</span> Track and forecast growth of 45+ crops using temperature-based heat accumulation.</li>
                    </ul>
                </div>
                ...
                <div style={styles.section}>
                    ...
                    <div style={styles.subsection}>
                        <SubsectionTitle icon={
                            ...
                            9. Growing Degree Days (GDD) Calculation
                        </SubsectionTitle>
                        <ul style={styles.list}>
