        ...
        <>
            ...
            <div style={styles.section}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <div style={{ position: 'relative', zIndex: 2, flex: 1, display: 'flex', flexDirection: 'column' }}>
                            <h3 style={{ margin: '0 0 15px 0', fontSize: '28px', fontWeight: '600', letterSpacing: '0.5px' }}>
                                Irrigation Scheduler Tool Demo
                            </h3>
                            <p style={{ margin: '0 0 30px 0', fontSize: '16px', opacity: 0.9, lineHeight: '1.6' }}>
                                Get a comprehensive walkthrough of all features in the Irrigation Scheduler App. Learn how to optimize irrigation timing and amounts using soil moisture data, weather forecasts, and crop water demand models.
                            </p>
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                <div style={{
                                    ...
                                    <iframe
                                        ...
                                        src="https://www.youtube.com/embed/HgfBcRGxnDU"
                                        title="Irrigation Scheduler Video"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowFullScreen
                                    />
                                </div>
                                <a
                                    href="https://youtu.be/HgfBcRGxnDU"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    style={{
                    ...
                    {/* Irrigation Scheduler Tool Demo (Mobile) */}
                    <div style={{
                        flex: '1',
                        ...
                        <div style={{ position: 'relative', zIndex: 2, flex: 1, display: 'flex', flexDirection: 'column' }}>
                            ...
                            <p style={{ margin: '0 0 30px 0', fontSize: '16px', opacity: 0.9, lineHeight: '1.6' }}>
                                Use the Irrigation Scheduler on your mobile device. Learn how to monitor soil moisture and schedule irrigations efficiently from the field on smaller screens.
                            </p>
                            <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '20px' }}>
                                <div style={{ position: 'relative', width: '100%', flex: 1, minHeight: '300px', backgroundColor: 'rgba(0,0,0,0.1)', borderRadius: '12px', overflow: 'hidden' }}>
                                    <iframe
                                        style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: 'none' }}
                                        src="https://www.youtube.com/embed/S3BqpLwYAKU"
                                        title="Irrigation Scheduler Tool Demo Video (Mobile)"
                                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                        allowFullScreen
                                    />
                                </div>
                                <a href="https://youtu.be/S3BqpLwYAKU" target="_blank" rel="noopener noreferrer"
