...
const CantaloupeContent = ({ isMobile, colors, styles }) => {
    return (
        <div style={{
            ...
            {/* Visual Flow Diagram for Cantaloupe */}
            <div style={{
                ...
                <div style={{
                    ...
                    {[
                        ...
                        { stage: 'Vine Development', gdd: '200-400', color: '#90CAF9' },
                        { stage: 'Flowering', gdd: '400-600', color: '#64B5F6' },
                        { stage: 'Fruit Set', gdd: '600-800', color: '#42A5F5' },
                        { stage: 'Fruit Enlargement', gdd: '800-1200', color: '#2196F3' },
            ...
            <div style={{
                ...
                <div>
                    ...
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Seeds absorb moisture and sprout; radicle and shoot emerge.</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Cotyledons unfold and first true leaves appear.</li>
                    </ul>
                </div>
                ...
                <div>
                    <h5 style={{
                        ...
                        3. Vine Development (200-400 GDD)
                    </h5>
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Vines rapidly elongate; canopy fills out.</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Male and female flowers open; pollination by bees is essential.</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Flowers develop into small, developing cantaloupes.</li>
                    </ul>
                </div>
                ...
                <div>
                    <h5 style={{
                        ...
                        6. Fruit Enlargement (800-1200 GDD)
                    </h5>
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Fruits grow in size; sugars accumulate.</li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul style={{...styles.list, marginLeft: '15px'}}>
                        <li style={styles.listItem}>Melons reach harvest maturity; rind hardens and aroma develops.</li>
                    </ul>
                </div>
            </div>
                ...
                <div style={{
                    ...
                    <div>
                        <ul style={{...styles.list}}>
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://vegetableipmupdates.arizona.edu"
                                    target="_blank" 
                                ...
                                <span style={{fontSize: '13px', display: 'block', color: '#666', marginTop: '2px'}}>
                                    Cantaloupe (Melon) Growth and Development
                                </span>
                            </li>
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://extension.okstate.edu"
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    style={{color: colors.link, textDecoration: 'none', fontWeight: '500'}}
                                >
                    ...
                    <div>
                        <ul style={{...styles.list}}>
                            <li style={{...styles.listItem}}>
                                <a 
                                    href="https://anrcatalog.ucanr.edu"
                                    target="_blank" 
                                    rel="noopener noreferrer" 
                                    style={{color: colors.link, textDecoration: 'none', fontWeight: '500'}}
                                >
...
export default CantaloupeContent; 